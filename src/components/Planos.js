    ...
    <>
      ...
      >
        <div className="form-abrir-empresa">
          <form
            action="https://paginas.rocks/Pages/Index/460790"
            method="post"
            target="_blank"
          >
      ...
      <section className="planos-wrapper" id="planos">
        <div className="container">
          <h1>Você pediu e nós atendemos</h1>
          ...
          <h2>PLANOS ACESSÍVEIS A PARTIR DE R$ 117,00</h2>
          <p className="planos-subtitle">SIMPLIFICAMOS TUDO PARA VOCÊ</p>
          <div className="three-cards-wrapper">
            <div className="card-wrapper">
              <p className="title">EMPRESA MEI</p>
            ...
            <div className="card-wrapper">
              <p className="title">EMPRESA DE SERVIÇOS</p>
            ...
            <div className="card-wrapper">
              <p className="title">EMPRESA DE COMÉRCIO</p>
          ...
          <div className="container">
            <p className="duvidas">
              ...
              <br />
              Converse com o nosso especialista que vai te ajudar e apresentar a
              melhor proposta para o seu negócio!
            </p>
          </div>
          <a
            target="_blank"
          ...
          >
            <button className="planos-btn">Tire dúvidas no WhatsApp</button>
          </a>
        </div>
      </section>
    </>
